...
<html>
	<head>
		...
		<style>
			body {
				  background-image: url("encor_duplex.jpg");
	...
	<body>
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Encore Three Bedrooms Duplex</p><p id="welcom_msg">Verona resort room with one king or two double Beds, featuring a dramatic view overlooking Verona lake.</p></div>
				
		<div id="check_availability">
		
		<form action="encor_duplex_booking.php">

...
<html>
	<head>
		...
		<style>
			body {
				  background-image: url("tower_suite_salon.jpg");
	...
	<body>
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Verona Tower Suite Salon</p><p id="welcom_msg">With one king or two double dream beds anchor the 650-square-foot resort room living and dining furnishing evoke luxury living.</p></div>
				
		<div id="check_availability">
		
		<form action="tower_suite_salon_booking.php">

...
<html>
	...
	<body>  
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Verona Panoramic View</p><p id="welcom_msg">Classic Double With One double bed anchor the 650-square-foot resort room living and dining furnishing evoke luxury living.</p></div>
		...
		<p class = "confirmation_code"><?php echo $confMssg;?></p>
		   ...
		   <div class="personal-info">
				...
				<form method="post" action = "panoramic_view_booking_confirmation.php">

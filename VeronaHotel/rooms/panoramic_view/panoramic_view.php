...
<html>
	...
	<body>
		...
		<ul>
			<li><a class="logo" href="D:\courses\software engineering\Web\Projects\HotelDemo\home\home.html" target="_self"><img class="logo" src="logo.jpg"
		           style="width:80px;height:50px;border:0;"></a></li>
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Verona Panoramic View</p><p id="welcom_msg">Verona resort room with one king or two double Beds, featuring a dramatic view overlooking Verona lake.</p></div>
				
		<div id="check_availability">
		
		<form action="panoramic_view_booking.php">

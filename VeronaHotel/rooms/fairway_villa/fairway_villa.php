...
<html>
	<head>
		...
		<style>
			body {
				  background-image: url("fairway_villa.jpg");
	...
	<body>
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Verona Fairway Villa</p><p id="welcom_msg">Verona resort room with one king or two double Beds, featuring a dramatic view overlooking Verona lake.</p></div>
				
		<div id="check_availability">
		
		<form action="fairway_villa_booking.php">

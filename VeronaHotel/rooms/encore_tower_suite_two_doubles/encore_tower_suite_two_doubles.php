...
<html>
	<head>
		...
		<style>
			body {
				  background-image: url("encore_tower_suite_two_doubles.jpg");
	...
	<body>
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Verona Tower Suite Two Doubles</p><p id="welcom_msg">With one king or two double dream beds anchor the 650-square-foot resort room living and dining furnishing evoke luxury living.</p></div>
				
		<div id="check_availability">
		
		<form action="encore_tower_suite_two_doubles_booking.php">

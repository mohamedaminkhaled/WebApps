...
<html>
	...
	<body>  
		...
		<?php 
			...
			$sql2 = "SELECT `NUMBER` FROM `ROOM` WHERE `CATEGORY` = 'Verona Panoramic Corner King' ;";
			//use excec() because no results are returned
		...
		<p class = "confirmation_code"><?php echo $confMssg;?></p>
		   ...
		   <div class="personal-info">
				...
				<form method="post" action = "classic_double_booking_confirmation.php">
   ...
   <input class="input-style location" type="text" name="country" pattern="[a-zA-Z ]*" required>                         <input class="input-style location" type="text" name="conf" value = <?php echo $confCode?> pattern="[0-9]{7}" required>

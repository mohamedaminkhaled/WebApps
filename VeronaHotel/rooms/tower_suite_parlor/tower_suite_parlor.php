...
<html>
	<head>
		...
		<style>
			body {
				  background-image: url("tower_suite_parlor.jpg");
	...
	<body>
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Verona Tower Suite Parlor</p><p id="welcom_msg">Unique corner rooms from 28th floor and above showcase view of verona city through floor-to-celing windows.</p></div>
				
		<div id="check_availability">
		
		<form action="tower_suite_parlor_booking.php">

...
<html>
	<head>
		...
		<style>
			body {
				  background-image: url("encore_two_queens.jpg");
	...
	<body>
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Encore Tower Suite Two Queens</p><p id="welcom_msg">With one king or two double dream beds anchor the 650-square-foot resort room living and dining furnishing evoke luxury living.</p></div>
				
		<div id="check_availability">
		
		<form action="encore_two_queens_booking.php">

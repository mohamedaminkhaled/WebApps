...
<html>
	<head>
		...
		<style>
			body {
				  background-image: url("encore_king.jpg");
	...
	<body>
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Encore Tower Suite King</p><p id="welcom_msg">Verona resort room with one king or two double Beds, featuring a dramatic view overlooking Verona lake.</p></div>
				
		<div id="check_availability">
		
		<form action="encore_king_booking.php">

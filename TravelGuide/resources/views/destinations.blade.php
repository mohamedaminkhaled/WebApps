...
<body>
                ...
                @foreach($destinations as $destination)
                    <div class="col-lg-4 col-md-6">
                        <div class="single_destination">
                            <div class="thumb">
                                <img src="storage/storage/destinations_images/{{$destination->image}}" alt="">
                            </div>
    ...
    <div class="newletter_area overlay">
        <div class="container">
            {!! Form::open(['action'=>'App\Http\Controllers\DestinationsController@store', 'method'=>'POST','enctype'=>'multipart/form-data']) !!}
                @csrf
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-lg-3 col-md-4">
                                            ...
                                            <div class="newsletter_btn">
                                                <button class="boxed-btn4 " name="forma-add-destination" type="submit" >Add</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

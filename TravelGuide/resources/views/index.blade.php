                ...
                @foreach($destinations as $destination)
                    <div class="col-lg-4 col-md-6">
                        <div class="single_destination">
                            <div class="thumb">
                                <img src="storage/destinations_images/{{$destination->image}}" alt="">
                            </div>
                            ...
                            <div class="content">
                                <p class="d-flex align-items-center">{{$destination->name}} <a href="travel_destination">{{count($places)}} Places</a> </p>
                            </div>
                        </div>
                    </div>
                @endforeach
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-lg-3 col-md-4">
                                            <div class="newsletter_btn">
                                                <button class="boxed-btn4 " id="add_destination" >Add</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                @foreach($allPlaces as $place)
                    <div class="col-lg-4 col-md-6">
                        <div class="single_place">
                            <div class="thumb">
                                <img src="storage/places_images/{{$place->image}}" alt="">

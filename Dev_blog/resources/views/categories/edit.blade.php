            ...
            <div class="card card-6">
                ...
                <div class="card-body">
                    {!! Form::open(['action'=>['CategoryController@update',$category->id], 'method'=>'POST','enctype'=>'multipart/form-data']) !!}
                        <div class="form-row">
                            <div class="name"  for="exampleInputEmail1">Category Name</div>
                            <div class="value">
                                <input name="name" type="text" class="input--style-6" value = "{{$category->name}}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group js-input-file">
                                    <input class="choose-file" type="file" name="category_image">
                                </div>
                            </div>
                        </div>

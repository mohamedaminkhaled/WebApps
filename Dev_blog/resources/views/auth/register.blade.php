			...
			<div class="wrap-login100">
				...
				<form method="POST" action="{{ route('register') }}" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input id="name" name="name" type="text" class="input100{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Enter name" required>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input id="email" type="email" class="input100{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required placeholder="Enter email">

...
<html>
	...
	<body>  
		...
		<?php 
			...
			//sql to select data
			$sql = "SELECT TODAYPRICE FROM room WHERE CATEGORY = 'Verona Resort' LIMIT 1;";
			...
			$sql2 = "SELECT `NUMBER` FROM `ROOM` WHERE `CATEGORY` = 'Verona Resort' ;";
			//use excec() because no results are returned
		...
		<p class = "confirmation_code"><?php echo $confMssg;?></p>
		   ...
		   <div class="personal-info">
				...
				<form method="post" action = "verona_resort_booking_confirmation.php">

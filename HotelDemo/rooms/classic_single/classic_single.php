...
<html>
	...
	<body>
		...
		<form method="post" action="classic_single_booking.php">
<pre>  Checkin*           Checkout*          Occupancy*
  <input class="input-style" type="date" name="chickin" required>  <input class="input-style" type="date" name="checkout" required>  <input class="input-style occupancy" type="number" name="occupancy"  min="1" max="1" required>         <input class="input-style booking" type="submit" value="Check Availability">
  </pre>
</form>
		</div>

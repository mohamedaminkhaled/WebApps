...
<html>
	<head>
		...
		<style>
			body {
				  background-image: url("encore_apartment.jpg");
	...
	<body>
		...
		<div><p id="p_welcom" style="margin-bottom:20px;">Encore Two Bedroom Apartment</p><p id="welcom_msg">With one king or two double dream beds anchor the 650-square-foot resort room living and dining furnishing evoke luxury living.</p></div>
				
		<div id="check_availability">
		
		<form action="encore_apartment_booking.php">

...
<html>
	...
	<body>
		...
		<form action="classic_single_booking.php">
<pre>    Checkin*         Checkout*
    <input class="input-style" type="date" name="chickin">    <input class="input-style" type="date" name="checkout">         <input class="input-style booking" type="submit" value="Check Availability">
    </pre>
</form>
		</div>
